import 'package:banking_app/1_src/home/account_widget.dart';
import 'package:banking_app/1_src/home/activity_widget.dart';
import 'package:banking_app/1_src/home/models/activities.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void listenScrolling() {
    if (_lvController.position.pixels == _lvController.position.maxScrollExtent) {
      _getMoreActivities();
    }
                  ...
                  SizedBox(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext ctxt, int index) {
                        if (index == _lvActivities.length && index < _filtredActivities.length) {
                          return Center(
                            child: Container(
